...
create table proveedor        (id integer not null auto_increment, nombre varchar(512) not null, direccion varchar(255), primary key (id)) engine=innodb charset=utf8mb4 collate=utf8mb4_bin;
