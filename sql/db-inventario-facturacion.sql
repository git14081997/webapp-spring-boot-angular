...
drop table if exists inventario_facturacion.cliente_abona
drop table if exists inventario_facturacion.factura
drop table if exists inventario_facturacion.factura_detalle
drop table if exists inventario_facturacion.imagen_producto
drop table if exists inventario_facturacion.ingresos_egresos
drop table if exists inventario_facturacion.inventario
drop table if exists inventario_facturacion.producto
drop table if exists inventario_facturacion.usuario
